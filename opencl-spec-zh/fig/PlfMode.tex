...
label(btex \mplabel{Processing\\
Element} etex, (0,0)) shifted (-20u,-4u);
draw ((-18u,-4u)--(-12u,-6u));

label(btex \mplabel{Compute Unit} etex, (0,0)) shifted (-11u,-11u);
draw ((-11u,-10u)--(-6u,-8u));

label(btex \mplabel{Compute\\
Device} etex, (0,0)) shifted (7u,-10u);
draw ((4u,-9u)--(0u,-8u));
)
enddef;
