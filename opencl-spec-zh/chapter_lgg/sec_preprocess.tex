...
\startclc
/BTEX\ftClcEmp{\# pragma}/ETEX /BTEX{\ftClcRef{pp-tokens\low{opt} new-line}}/ETEX
\stopclc
...
\startclc
/BTEX\ftClcEmp{\#pragma OPENCL FP_CONTRACT}/ETEX /BTEX\ftClcRef{on-off-switch}/ETEX
	/BTEX\ftClcRef{on-off-switch}/ETEX: one of /BTEX\ftClcEmp{ON OFF DEFAULT}/ETEX

/BTEX\ftClcEmp{\#pragma OPENCL EXTENSION}/ETEX extensionname : behavior
/BTEX\ftClcEmp{\#pragma OPENCL EXTENSION}/ETEX all : behavior
\stopclc
...
\ccmm{__kernel_exec(X, }\cldtv{type}\ccmm{)}
（和 \ccmm{kernel_exec(X, }\cldtv{type}\ccmm{)}）
定義為：
\startclc
__kernel __attribute__((work_group_size_hint(X, 1, 1))) \
	 __attribute__((vec_type_hint(type/BTEX\ftClcRef{n}/ETEX)))
\stopclc
