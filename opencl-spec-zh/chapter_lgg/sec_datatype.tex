...
數據型別 \cldt{half} 只能用於聲明指針，指向含有 \cldt{half} 值的緩衝區。
下面是幾個例子。
\startclc
...
函式 \capi{vload_half}、 \capi[n]{vload_half}、 \capi[n]{vloada_half}
和 \capi{vstore_half}、 \capi[n]{vstore_half}、 \capi[n]{vstorea_half}
