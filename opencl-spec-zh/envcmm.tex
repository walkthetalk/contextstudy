...
\definetype[clextname][
  style=\rm\bf,
]
\definetype[cldatatypes][
  style=\tt\tf,
]

\definetype[cldatatypev][
  style=\tt\it,
]
\define[1]\cldts{\cldatatypes{#1}}
\define[1]\cldtv{\cldatatypes{#1}\cldatatypev{n}}
\define[1]\cldtvv{\cldatatypes{#1}\cldatatypev{n}\cldatatypes{x}\cldatatypev{m}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%layout%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%% TD: type / desc
\def\startCLTD{\dostartCLTD}

\long\def\dostartCLTD#1\stopCLTD{%
  \startlocalfootnotes
  \bTABLE[option=stretch]
  \bTABLEhead
    \bTR[background=color,backgroundcolor=gray]
...
\long\def\dostartCLTT#1\stopCLTT{%
  ...
  \bTABLEhead
    \bTR[background=color,backgroundcolor=gray]
        \bTH OpenCL 語言中的類型 \eTH
        \bTH 應用所用 API 中的類型 \eTH
    \eTR
  \eTABLEhead
  \bTABLEbody
    #1
