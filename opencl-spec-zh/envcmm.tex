...
\definehead[topclfunc][
  indentnext=yes,
  style=bold,%normal bold slanted boldslanted % 整体
  incrementnumber=list,
  number=no, %yes no % 是否帶編號
  before={\blank[1ex]}, %COMMAND
  after={}, %COMMAND
  alternative=normal, %normal inmargin middle TEXT
  deeptextcommand={\framed[
    frame=on, corner=0, frameoffset=.5ex,
    framecolor=black,background=color,
    backgroundcolor=gray, backgroundoffset=.5ex,
