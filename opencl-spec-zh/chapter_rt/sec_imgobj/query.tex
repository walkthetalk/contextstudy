...
\carg{flags} 是位欄，用來描述所創建的\cnglo{imgobj}的分配和用法資訊。參見\reftab{clmapflags}。
...
\item \cenum{CL_INVALID_VALUE}，如果 \carg{flags} 或 \carg{image_type} 無效，或者 \carg{num_entries} 是 0 且 \carg{image_formats} 是 \cmacro{NULL}。
