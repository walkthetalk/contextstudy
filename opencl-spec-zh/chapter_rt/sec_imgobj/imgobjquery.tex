...
\carg{param_value} 用來存儲查詢結果。如果 \carg{param_value} 是 \cmacro{NULL}，則忽略。
...
或者 \cenum{param_value_size} 的值 < \reftab{clgetimginfo}中返回型別的大小並且 \cenum{param_value} 不是 \cmacro{NULL}，
