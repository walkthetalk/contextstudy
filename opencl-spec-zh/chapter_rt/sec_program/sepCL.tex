...
\startigBase
\item 編譯階段、鏈接階段的分離。編譯階段可以將\cnglo{program}源碼編譯程二進制目標碼，而鏈接階段可以將其與其他目標碼鏈接程可執行\cnglo{program}。

\item 內嵌頭檔。在 OpenCL 1.0 和 1.1 中，對於\cnglo{program}源碼所包含的頭檔而言，構建選項 -I 可以用來指定其搜索路徑。
