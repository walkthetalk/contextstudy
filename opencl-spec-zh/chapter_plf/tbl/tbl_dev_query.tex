...
\clETD{
  ...
  如果不支持擴展 \clextname{cl_khr_fp16}，\cenum{CL_DEVICE_PREFERRED_VECTOR_WIDTH_HALF} 必須返回0。
}
...
\clETD{
  ...
  如果不支持擴展 \clextname{cl_khr_fp16}，\cenum{CL_DEVICE_NATIVE_VECTOR_WIDTH_HALF} 必須返回0。
}
...
\clETD{CL_DEVICE_EXTENSIONS}{char[]}{
  ...
  \startigBase
  \item \clextname{cl_khr_int64_base_atomics}
  \item \clextname{cl_khr_int64_extended_atomics}
  \item \clextname{cl_khr_fp16}
  \item \clextname{cl_khr_gl_sharing}
  \item \clextname{cl_khr_gl_event}
  \item \clextname{cl_khr_d3d10_sharing}
  \item \clextname{cl_khr_media_sharing}
  \item \clextname{cl_khr_d3d11_sharing}
  \stopigBase

  對於支持 OpenCL C \scver 的\cnglo{device}，所返回的清單中必須包含下列已獲 Khronos 批准的擴展名：
  \startigBase
  \item \clextname{cl_khr_global_int32_base_atomics}
  \item \clextname{cl_khr_global_int32_extended_atomics}
  \item \clextname{cl_khr_local_int32_base_atomics}
  \item \clextname{cl_khr_local_int32_extended_atomics}
  \item \clextname{cl_khr_byte_addressable_store}
  \item \clextname{cl_khr_fp64}（如果支持雙精度浮點，為向後兼容必須支持此擴展）
