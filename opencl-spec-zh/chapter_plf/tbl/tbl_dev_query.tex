...
\math{max(\text{\cenum{CL_DEVICE_GLOBAL_MEM_SIZE}} * 1/4, 128 * 1024 * 1024)}
}
...
如果 OpenCL \cnglo{device}是 little-endian 的，
則為 \cenum{CL_TRUE}，否則為\cenum{CL_FALSE}。
}
...
在 OpenCL 和其他 API （如 DirectX ）間共享\cnglo{memobj}時，
