...
其中每個\cnglo{subdev}包含一組\cnglo{computeunit}，且他們之間沒有交集。
...
\item \cenum{CL_INVALID_VALUE}，如果 \carg{out_devices} 不是 \cmacro{NULL}，且 \carg{num_devices} 小於所創建\cnglo{subdev}的數目。
