...
其值必須 >= \reftab{cldevquery}所列返回類型的大小。
...
或者 \cenum{param_value_size} 的值 < \reftab{cldevquery}中返回類型的大小並且 \cenum{param_value} 不是 \cenum{NULL}，
